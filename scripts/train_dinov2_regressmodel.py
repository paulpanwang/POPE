...
from dinov2_regression_modelv3 import DINOv2Poser
    ...
    while should_keep_training:
        ...
        with tqdm(train_loader, unit="batch") as tepoch:
            for i_batch, item in enumerate(tepoch):
                ...
                if train_steps % 1000 == 0 and (gpu == 0 or args.no_ddp) and is_training:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--steps', type=int, default=120000000)
    ...
    parser.add_argument('--ckpt', default="",  help='checkpoint to restore')
