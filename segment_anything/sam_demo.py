...
def gen_masks(masks, image, base_name):
    ...
    for idx, mask in enumerate(sorted_masks):
        ...
        # print(f"crop_images/{prefix_name}-{idx}.jpg")
        # cv2.imwrite(f"crop_images/{prefix_name}-{idx}.jpg", crop_img)
...
if __name__ == "__main__":
    ...
    ROOT_DIR = "/mnt/bn/raoqiang-lq-nas/panpanwang/data/Gen6d/data/LINEMOD/ape/JPEGImages"
    import os 
